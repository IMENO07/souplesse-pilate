...
function Hero() {
  ...
  const cardImg = images.length > cardIdx ? images[cardIdx] : (images.length > 0 ? images[0] : '');
...
function StudioShowcase() {
  ...
  const img1 = images.length > 0 ? images[0] : 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&q=80';
  const img2 = images.length > 1 ? images[1] : 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80';
