 ...
 */
function Dialog({ isOpen, onClose, children, size = 'md' }) {
  ...
  return (
    <div className="ui-dialog-overlay" onClick={onClose}>
      ...
      >
        {children}
        <button className="ui-dialog-close" style={{ position: 'absolute', top: 16, right: 16 }} onClick={onClose} aria-label="Fermer">
...
function DialogHeader({ children }) { return <div className="ui-dialog-header">{children}</div>; }
function DialogTitle({ children }) { return <h2 className="ui-dialog-title">{children}</h2>; }
function DialogDescription({ children }) { return <p className="ui-dialog-description">{children}</p>; }
function DialogBody({ children }) { return <div className="ui-dialog-body">{children}</div>; }
function DialogFooter({ children }) { return <div className="ui-dialog-footer">{children}</div>; }
